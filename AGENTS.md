# LPConcentratedARBUSDCStrategy - Agent Guide

> AI coding agent context for the `l_p_concentrated_a_r_b_u_s_d_c` strategy.

## Overview

- **Template:** dynamic_lp
- **Chain:** arbitrum
- **Class:** `LPConcentratedARBUSDCStrategy` in `strategy.py`
- **Config:** `config.json`
